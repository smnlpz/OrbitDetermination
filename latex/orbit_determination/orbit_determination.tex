...
\begin{document}
\input{burocracia/portada}
\input{burocracia/prefacio}
...
\input{chapters/2_laplace}
\input{chapters/3_admisible_solutions}
\input{chapters/4_implementation}
\input{chapters/5_experimentation}
\input{chapters/6_conclusions}

\appendix
\input{appendix/installation_and_use}
