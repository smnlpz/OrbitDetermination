...
Antes de entrar de lleno en las matemáticas, veamos un poco de historia sobre la determinación de órbitas.\\
...
\section{Familiarizándos con el problema.}
...
%El espacio de todas las elipses con foco en el origen es una variedad de cinco elementos.
...
\chapter{Estudio del número de soluciones admisibles}
